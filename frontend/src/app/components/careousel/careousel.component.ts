...
@Component({
  selector: 'app-careousel',
  templateUrl: './careousel.component.html',
  styleUrls: ['./careousel.component.scss'],
})
export class CareouselComponent implements OnInit, OnDestroy {
      ...
      .subscribe(
        (datas) => {
          if (datas.length >= 3) {
            ...
            this.indexRight = 0;
            this.indexLeft = 1;
            this.carouselService.sortImages(datas);
